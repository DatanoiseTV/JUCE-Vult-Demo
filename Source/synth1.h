...
static_inline float Synth1_smooth(Synth1__ctx_type_0 &_ctx, float input){
...
static_inline uint8_t Synth1_change(Synth1__ctx_type_1 &_ctx, float x){
   uint8_t v;
   v = (_ctx.pre_x != x);
   _ctx.pre_x = x;
   return v;
...
typedef struct Synth1__ctx_type_7 {
   ...
   float detune;
   int count;
   Synth1__ctx_type_0 _inst6c9;
   Synth1__ctx_type_0 _inst5c9;
   Synth1__ctx_type_5 _inst4a2;
   Synth1__ctx_type_0 _inst3c9;
   Synth1__ctx_type_5 _inst2a2;
   Synth1__ctx_type_6 _inst1c8;
} Synth1__ctx_type_7;
